...
import { Head, SubHead, Para, CustomImg, MinHead, UL, MotionPara, MotionLeft, MotionRight } from "../components/decoration";
...
export default function Work() {
    return (
        <>
            <section className="lg:mt-2.5">
                <Head>
                    <span className="relative z-10 after:absolute  after:inset-0 after:-z-10 after:rounded-full after:bg-cyan-200/75 after:opacity-20 after:blur-xl hover:after:opacity-30">
                        Work & <span className=" bg-logo text-transparent bg-clip-text">
                            Experience
                        </span>
                    </span>
                </Head>
            ...
            <section className="mt-12 flex flex-col gap-16">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 ">
                    <MotionLeft>
                        <div className="order-1" >
                            <div className="glass-effect rounded-3xl p-4 lg:p-8 card-hover">
                    ...
                    <MotionRight>
                        <div className="order-2 hover:scale-102 hover:brightness-105 duration-200 transition">
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 ">
                    <MotionLeft>
                        <div className="order-1" >
                            <div className="glass-effect rounded-3xl p-4 lg:p-8 card-hover">
                                <div className="flex  mb-1 gap-3">
                                    <div className="aspect-square p-2 rounded-full bg-[#18191D] h-max">
                                        <CustomImg src="/tc_favicon.webp" alt="notify breach logo" width={20} height={20}></CustomImg>
                                    </div>
                                    <div>
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 ">
                    <MotionLeft>
                        <div className="order-1" >
                            <div className="glass-effect rounded-3xl p-4 lg:p-8 card-hover">
                                <div className="flex  mb-1 gap-3">
                                    <div className="p-1.5 rounded-full bg-amber-50 h-max flex items-center justify-center aspect-square">
                                        <CustomImg src="/th_fav.png" alt="notify breach logo" width={26} height={26}></CustomImg>
                                    </div>
                                    <div>
                                        <SubHead>Team Hash Foundation </SubHead>
                                        <span className="text-zinc-400 text-sm font-light">August 2025</span>
                                    </div>
                                </div>

                                <Para>
                                    TeamHashFoundation.com represents a non-profit dedicated to internet safety. Established in 2022, it highlights initiatives like #CyberCop and #CyberKatha, supporting law enforcement, startups, and public awareness while showcasing the foundation’s mission, impact, and campaigns.
                                </Para>
                                <MinHead>What I Built</MinHead>
                                <UL>
                                    <li className="list-disc marker:text-rose-400"> <span className="text-white underline">Multi-Page Structure  </span> → Designed and developed 8 key pages including About, Campaigns, Impact, Mission, and Donation Support.</li>
                                    <li className="list-disc marker:text-rose-400 "> <span className="text-white underline">Donation Support System</span> →  Built a dedicated page for supporters to contribute easily and securely.</li>
                                    <li className="list-disc marker:text-rose-400 "> <span className="text-white underline">Impact & Campaign Showcases</span>  → Structured sections to highlight the foundation’s achievements and ongoing initiatives like #CyberCop and #CyberKatha.</li>
                                </UL>

                                <a href="https://teamhashfoundation.org/" rel="nofollow" target="_blank" className="flex flex-wrap gap-4 mt-5">
                                    <button
                                        type="button"
                                        className="inline-flex items-center gap-x-2 rounded-lg bg-gradient-to-r from-yellow-500 to-yellow-600/90  px-3.5 py-2.5 hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 transform hover:scale-105 text-white cursor-pointer font-medium focus-visible:outline-2 focus-visible:outline-offset-2 "
                                    >
                                        Teamhashfoundation.org
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className="size-5"
                                            viewBox="0 0 24 24"
                    ...
                    <MotionRight>
                        <div className="order-2 hover:scale-102 hover:brightness-105 duration-200 transition">
                            <div className="relative">
                                <div className="absolute inset-0 bg-gradient-to-r from-amber-400/80 to-yellow-500/80 rounded-3xl blur-xl opacity-30"></div>
                                <div className="relative bg-zinc-800 rounded-3xl p-8 border border-yellow-400/60 shadow-lg">
                                    <div className="bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-2xl h-96 flex items-center justify-center">
                                        <div className="rounded-xl w-full h-full relative">
                                            <CustomImg src="/teamhash.webp" alt="tier cards ui" fill={true} classNames="w-full h-full rounded-xl" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 ">
                    <MotionLeft>
                        <div className="order-1" >
                            <div className="glass-effect rounded-3xl p-4 lg:p-8 card-hover">
                                <div className="flex  mb-1 gap-3">
                                    <CustomImg src="/soundcup_fav.webp" alt="notify breach logo" width={30} height={30}></CustomImg>
                                    <div>
                                        <SubHead>Sound Cup Pro </SubHead>
                                        <span className="text-zinc-400 text-sm font-light">June 2024</span>
                                    </div>
                                </div>

                                <Para>
                                    SoundCup.pro is a fun platform for meme and viral sound effects. It allows users to explore a wide range of sounds, download their favorites, and engage with content through likes and saves—all in a playful, user-friendly interface.
                                </Para>
                                <MinHead>What I Built</MinHead>
                                <UL>
                                    <li className="list-disc marker:text-rose-400"> <span className="text-white underline">Custom Audio Card Player  </span> → Designed and developed an interactive player for browsing and playing sound clips.</li>
                                    <li className="list-disc marker:text-rose-400 "> <span className="text-white underline">Download Feature </span> →  Enabled users to quickly download their favorite sounds.</li>
                                    <li className="list-disc marker:text-rose-400 "> <span className="text-white underline">Like & Save System </span>  → Added functionality to like and save sounds for easy access later.</li>
                                    <li className="list-disc marker:text-rose-400 "> <span className="text-white underline">From Design to UI  </span>  → Handled everything from concept design to polished, responsive user interface.</li>
                                </UL>

                                <a href="https://soundcup.pro/" rel="nofollow" target="_blank" className="flex flex-wrap gap-4 mt-5">
                                    <button
                                        type="button"
                                        className="inline-flex items-center gap-x-2 rounded-lg bg-gradient-to-r from-emerald-500 to-emerald-600/90  px-3.5 py-2.5 hover:from-emerald-400 hover:to-emerald-500 transition-all duration-300 transform hover:scale-105 text-white cursor-pointer font-medium focus-visible:outline-2 focus-visible:outline-offset-2 "
                                    >
                                        Soundcup.pro
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <MotionRight>
                        <div className="order-2 hover:scale-102 hover:brightness-105 duration-200 transition">
                            <div className="relative">
                                <div className="absolute inset-0 bg-gradient-to-r from-green-400/80 to-emerald-500/80 rounded-3xl blur-xl opacity-30"></div>
                                <div className="relative bg-zinc-800 rounded-3xl p-8 border border-emerald-400/60 shadow-lg">
                                    <div className="bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-2xl h-96 flex items-center justify-center">
                                        <div className="rounded-xl w-full h-full relative">
                                            <CustomImg src="/soundcup.webp" alt="tier cards ui" fill={true} classNames="w-full h-full rounded-xl" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 ">
                    <MotionLeft>
                        <div className="order-1" >
                            <div className="glass-effect rounded-3xl p-4 lg:p-8 card-hover">
                                <div className="flex  mb-1 gap-3">
                                    <CustomImg src="/cordcup_fav.webp" alt="notify breach logo" width={30} height={30}></CustomImg>
                                    <div>
                                        <SubHead>Cord Cup </SubHead>
                                        <span className="text-zinc-400 text-sm font-light">August 2024</span>
                                    </div>
                                </div>

                                <Para>
                                    CordCup is a collection of handy tools built for Discord users and developers. From generating timestamps to customizing fonts and creating server content, the platform makes it easier to design, manage, and personalize Discord experiences with simple, user-friendly utilities.
                                </Para>
                                <MinHead>What I Built</MinHead>
                                <UL>
                                    <li className="list-disc marker:text-rose-400"> <span className="text-white underline">Multiple Discord Tools   </span> → Developed utilities like timestamp generator, font generator, username generator, and bot name generator.</li>
                                    <li className="list-disc marker:text-rose-400 "> <span className="text-white underline">Advanced Server Utilities  </span> →  Built bot token generator, embed generator, role color picker, and channel topic generator.</li>
                                    <li className="list-disc marker:text-rose-400 "> <span className="text-white underline">User Interaction Features </span>  → Added welcome message and quote generators for easy personalization.</li>
                                    <li className="list-disc marker:text-rose-400 "> <span className="text-white underline">Complete UI Design  </span>  →  Designed clean, consistent, and responsive interfaces for all tools.</li>
                                </UL>

                                <a href="https://cordcup.com/" rel="nofollow" target="_blank" className="flex flex-wrap gap-4 mt-5">
                                    <button
                                        type="button"
                                        className="inline-flex items-center gap-x-2 rounded-lg bg-gradient-to-r from-fuchsia-500 to-fuchsia-600/90  px-3.5 py-2.5 hover:from-fuchsia-400 hover:to-fuchsia-500 transition-all duration-300 transform hover:scale-105 text-white cursor-pointer font-medium focus-visible:outline-2 focus-visible:outline-offset-2 "
                                    >
                                        Cordcup.com
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <MotionRight>
                        <div className="order-2 hover:scale-102 hover:brightness-105 duration-200 transition">
                            <div className="relative">
                                <div className="absolute inset-0 bg-gradient-to-r from-pink-400/80 to-fuchsia-500/80 rounded-3xl blur-xl opacity-30"></div>
                                <div className="relative bg-zinc-800 rounded-3xl p-8 border border-fuchsia-400/60 shadow-lg">
                                    <div className="bg-gradient-to-br from-fuchsia-100 to-fuchsia-200 rounded-2xl h-96 flex items-center justify-center">
                                        <div className="rounded-xl w-full h-full relative">
                                            <CustomImg src="/cordcup.webp" alt="tier cards ui" fill={true} classNames="w-full h-full rounded-xl" />
                                        </div>
                                    </div>
                                </div>
                            </div>
